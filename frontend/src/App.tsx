...
import { LuArmchair, LuLayers, LuSearch, LuUser, LuHeart, LuShoppingBag, LuMenu } from 'react-icons/lu'
import './App.css'
    ...
    <div>
      <header className="app-header">
        <nav className="nav nav-tabs">
          ...
          <button className="menu-btn" aria-label="Open menu" onClick={() => setMobileOpen(o => !o)}><LuMenu /></button>
          <div className={`mobile-dropdown ${mobileOpen ? 'open' : ''}`} onClick={() => setMobileOpen(false)}>
